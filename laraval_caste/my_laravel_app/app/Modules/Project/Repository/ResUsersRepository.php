...
class ResUsersRepository implements ResUsersRepositoryInterface
{
    public function __construct(protected ResUsers $model) {}
    ...
    public function all(array $filters = [], array $with = [])
    {
        ...
        foreach ($filters as $field => $value) {
            ...
            if (in_array($field, ['name'], true) && $value !== null && $value !== '') {
