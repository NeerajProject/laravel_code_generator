            ...
            <div className="mx-auto max-w-7xl">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-2xl font-semibold text-gray-900">ResPartner</h1>
                    </div>
                    <Link href="/customers/create" className="rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-indigo-700">Create</Link>
                </div>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <td className="px-4 py-3 text-sm text-gray-700">{record.is_active ?? "-"}</td>
                                    <td className="px-4 py-3 text-right">
                                        <Link href={`/customers/${record.id}`} className="font-medium text-indigo-600 hover:text-indigo-900">View</Link>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
