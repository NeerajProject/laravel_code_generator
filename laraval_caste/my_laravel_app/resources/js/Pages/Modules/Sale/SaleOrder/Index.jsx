            ...
            <div className="bg-white border-b border-gray-200 px-6 py-3 shadow-2xs">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <h1 className="text-xl font-bold text-gray-900">SaleOrder</h1>
                        <Link
                ...
                <div className="bg-white border border-gray-200 rounded shadow-2xs overflow-hidden">
                    <table className="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody className="divide-y divide-gray-100 bg-white">
                            ...
                            <td className="px-4 py-3 text-sm text-gray-700">{record.customer_id?.name ?? record.customer_id ?? "-"}</td>
                                ...
                                <tr>
                                    <td colSpan={11} className="px-4 py-16 text-center text-gray-500">
                                        <div className="flex flex-col items-center justify-center">
                                            ...
                                            <p className="text-base font-semibold text-gray-700">No SaleOrder records found</p>
