    ...
    return (
        <div className="p-6">
            ...
            <div className="flex justify-between mb-6">
                ...
                <Link href="/product-products/create" className="px-4 py-2 bg-blue-600 text-white rounded">Create</Link>
            </div>
                        ...
                        {records.data.map((row) => (
                            <tr key={row.id}>
                                ...
                                <td className="border p-2">
                                    <Link href={`/product-products/${row.id}/edit`} className="mr-3 text-blue-600">Edit</Link>
